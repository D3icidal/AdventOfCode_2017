puzzleInput = "vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh
...
#
# sentenceArray = puzzleInput.split("\n")
# uniqueArrays = []
# oneWordArrayTemp = []
#
# sentenceArray.each do |i|
#   oneSentenceArrayTemp = i.split(" ")
#   if oneSentenceArrayTemp.uniq.length == i.split(" ").length
#     uniqueArrays.push(i)
#     puts(i)
#   end
# end
...
uniqueArrays = []
oneWordArrayTemp = []
oneSentenceArrayTemptemp = []

sentenceArray.each do |i|
  oneSentenceArrayTemp = i.split(" ")
  oneSentenceArrayTemp.each do |k|
    puts("k.split("").sort: #{k.split("").sort}")
    oneSentenceArrayTemptemp.push(k.split("").sort)
    # puts (oneSentenceArrayTemptemp)
  end
  puts("oneSentenceArrayTemptemp: #{oneSentenceArrayTemptemp}\n\n")
  puts(oneSentenceArrayTemptemp.uniq.length)
  puts(i.split(" ").length)
  if oneSentenceArrayTemptemp.uniq.length == i.split(" ").length
    uniqueArrays.push(i)
    puts("yessirreeyy: i#{i}")
  end
  oneSentenceArrayTemptemp.clear
end




puts("\n\n\tUnique entries: #{uniqueArrays.length}")
